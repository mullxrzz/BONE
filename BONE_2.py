#setting up key functions and libraries 
import os
...
#add in the 250 mil max supply number?

#minted SHIBA SWAP BONE details
SHIBASWAP_BONE_contract_address = Web3.toChecksumAddress('0x9813037ee2218799597d83D4a5B6F3b6778218d9')
SHIBASWAP_BONE_contract_abi = json.loads(
...
#t BONE (staked bone) details
t_BONE_contract_address = Web3.toChecksumAddress('0xf7A0383750feF5AbaCe57cc4C9ff98e3790202b3')
t_BONE_contract_abi = json.loads(
...
#address for minted bone that is locked
unwoofed_BONE_address =  '0xa404f66b9278c4ab8428225014266b4b239bcdc7'

#set of SSLP and other addresses which do not form circ supply
xc95_BONE_address = '0xc9f512da761e121c2ff06abe3e7e13ba5752bbd8'
xf6B_BONE_address = '0xf6badfb9b0ab2f8f3fd8225ef1ea12fa689ad1a7'
x4bb_BONE_address = '0x4bb0cdd7c906151347ad915af07f6af50c9028f7'
x44c_BONE_address = '0x44c652d679d99bb406167de9651d2535850fb479'
xefb_BONE_address = '0xefb47fcfcad4f96c83d4ca676842fb03ef20a477'
xff6_BONE_address = '0xff64cb7ba5717a10dabc4be3a41acd2c2f95ee22'
...
#calling on supply of token in ether format using address and abi
def supply_ERC20(contract_address, contract_abi):
...
#calling on supply of bone in specific wallet using wallet address
...
WIBE  = supply_ERC20(SHIBASWAP_BONE_contract_address, SHIBASWAP_BONE_contract_abi)
print(type(WIBE))
print(isinstance(WIBE, int))

def BONE_circulating_supply():
    minted_supply = int(supply_ERC20(SHIBASWAP_BONE_contract_address,SHIBASWAP_BONE_contract_abi))
    staked_supply = int(supply_ERC20(t_BONE_contract_address,t_BONE_contract_abi))
    locked_supply = int(BONE_wallet_balance(unwoofed_BONE_address))
    SSLP_supply = int(BONE_wallet_balance(xc95_BONE_address)) + int(BONE_wallet_balance(xf6B_BONE_address)) + int(BONE_wallet_balance(x4bb_BONE_address)) + int(BONE_wallet_balance(x44c_BONE_address)) + int(BONE_wallet_balance(xefb_BONE_address)) + int(BONE_wallet_balance(xff6_BONE_address))
    circulating_supply = minted_supply - staked_supply - locked_supply - SSLP_supply
